<template>
    <div class="flex flex-col w-screen">
        <div class="h-auto w-screen relative bg-[#A7E7D3]">
            <img src="../assets/icons/Subtract.svg" class="h-auto w-screen">
            <h1 class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-semibold md:text-8xl text-2xl text-white">Revive Reef</h1>
        </div>
        ...
        <div class="md:h-96 h-40 w-screen relative">
            <img src="../assets/icons/level2.svg" class="h-auto w-screen absolute">
            <div class="flex flex-col h-full">
                <div class="h-1/2 bg-[#A7E7D3]"></div>
                <div class="h-1/2"></div>
            </div>
        </div>
