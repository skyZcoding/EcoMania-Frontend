<template>
    <div class="h-full w-full px-24 flex flex-col items-center justify-center md:pt-0 pt-24">
        <div class="flex flex-col md:flex-row justify-between w-full">
            ...
            <img v-bind:src="Image" class="h-[18rem] w-fit" alt="">      
        </div>
        <div class="w-fit">
            <p>
                {{ Story }}
...
export default {
    data() {
        return {
            ...
            Image: "/src/assets/tetrabreeze.jpeg"
        }
    },
    methods: {
        test() {
